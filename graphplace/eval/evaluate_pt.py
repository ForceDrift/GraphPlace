...
CHALLENGE_DIR = os.path.join(project_root, 'externals/macro-place-challenge-2026')
...
def main():
    ...
    source_dir = os.path.join(project_root, f'externals/MacroPlacement/Testcases/ICCAD04/{args.benchmark}')
